        ...
        <>
            <div className={`loader-wrapper ${loading ? 'show' : 'hide'}`}>
                ...
                <div className="socials">
                    <a className="social-link" href="https://twitter.com/lenguyentatthang" target="_top">
                    ...
                    <a className="social-link" href="https://www.linkedin.com/in/lenguyentatthang/" target="_top">
